...
//               <label className="form-lable fw-bold">
//                 Financial Year <span> {financial_year} </span>
//               </label>
...
//                  { !cat_text ? ( <option hidden>--select--</option>
//                   ) : (
//                    <option value={cat_text}>{category_option}</option>)
//                  }
//                 </select>
