...
//     // ✅ GENERATED BY MULTER
//     const fileName = req.generatedFileName; // e.g. 202512002014_MATTER_4.pdf
...
//     // ✅ STORE NAME & PATH SEPARATELY
//     request.input("link_name", sql.NVarChar(250), fileName);
//     // request.input("file_path", sql.NVarChar(300), filePath)
// ;
//     request.input("content_type", sql.NVarChar(100), req.file.mimetype);
//     request.input("file_size_in_bytes", sql.Numeric(18, 0), req.file.size);
...
//     const { ref_id, financial_year, sno, link_name, user_id, user_name = "" } = req.body;
//     if (!ref_id || !financial_year || !sno || !link_name || !user_id) {
...
//     request.input("ref_id", sql.VarChar(12), ref_id);
//     request.input("financial_year", sql.VarChar(9), financial_year);
//     request.input("sno", sql.Int, parseInt(sno));
//     request.input("link_name", sql.NVarChar(250), link_name);
